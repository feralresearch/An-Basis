...
namespace Basis.Editor
{
    public static class BasisDeepLinkPostProcess
    {
        private static string GetScheme() =>
            BasisClientConfiguration.Load(
                Path.Combine(Application.dataPath, "StreamingAssets")).DeepLinkScheme;
        ...
        {
            string bundleUrlName = $"org.{scheme}.deeplink";
    ...
    public class BasisDeepLinkAndroidPostProcess : IPostGenerateGradleAndroidProject
    {
        ...
        {
            string scheme = BasisClientConfiguration.Load(
                Path.Combine(Application.dataPath, "StreamingAssets")).DeepLinkScheme;
